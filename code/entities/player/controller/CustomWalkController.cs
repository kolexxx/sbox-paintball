...
namespace PaintBall
{
	// This is causing a lot of prediction errors and you move faster
	// while going into a wall. Copied and pasted from StandardWalkController.
	public partial class CustomWalkController : BasePlayerController
	{
		[Net] public float SprintSpeed { get; set; } = 150.0f;
		[Net] public float WalkSpeed { get; set; } = 150.0f;
		[Net] public float DefaultSpeed { get; set; } = 225.0f;
